...
public class IndexEstudoActivity extends BaseActivity {
    ...
    protected void registerInternalBindings() {
        Button btnCategoriasCientificas = (Button)findViewById(R.id.index_estudo_btn_categorias_cientificas);
        ...
        Button btnDisciplinas = (Button)findViewById(R.id.index_estudo_btn_disciplinas);
        ...
        Button btnAssuntos = (Button)findViewById(R.id.index_estudo_btn_assuntos);
