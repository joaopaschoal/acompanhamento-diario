...
public class ManageAssuntosActivity extends BaseActivity {
	...
	public void onContentChanged() {
		...
		ListView ltvItens = (ListView) findViewById(R.id.manage_assuntos_ltv_itens_assuntos);
	...
	public void onCreateContextMenu(ContextMenu menu, View v,
		...
		if (v.getId() == R.id.manage_assuntos_ltv_itens_assuntos) {
			...
			Assunto assunto = (Assunto) adapter.getItem(info.position);
	...
	public void clearScreen() {
		this.assunto = null;
		EditText edtNome = (EditText) findViewById(R.id.manage_assuntos_edt_name_assunto);
        edtNome.getText().clear();
        EditText edtNomeAbreviado = (EditText) findViewById(R.id.manage_assuntos_edt_nome_assunto_abreviado);
    ...
    private void bindEvents() {
        Button btnSalvar = (Button) findViewById(R.id.manage_assuntos_btn_save_assunto);
        ...
        ScrollView parentScrollView = (ScrollView)findViewById(R.id.manage_assuntos_parent_scrlvw);
	...
	protected Assunto fillObjectFromScreen(Assunto assunto) {
		EditText edtNome = (EditText) findViewById(R.id.manage_assuntos_edt_name_assunto);
        EditText edtNomeAbreviado = (EditText) findViewById(R.id.manage_assuntos_edt_nome_assunto_abreviado);
		Spinner spnDisciplinasSpinner = (Spinner) findViewById(R.id.manage_assuntos_spn_disciplinas);
		Spinner spnAssuntosSpinner = (Spinner) findViewById(R.id.manage_assuntos_spn_assuntos);
	...
	protected void fillScreenFromObject(Assunto assunto) {
		EditText edtNome = (EditText) findViewById(R.id.manage_assuntos_edt_name_assunto);
        EditText edtNomeAbreviado = (EditText) findViewById(R.id.manage_assuntos_edt_nome_assunto_abreviado);
		Spinner spnDisciplinas = (Spinner) findViewById(R.id.manage_assuntos_spn_disciplinas);
		Spinner spnAssuntos = (Spinner) findViewById(R.id.manage_assuntos_spn_assuntos);
