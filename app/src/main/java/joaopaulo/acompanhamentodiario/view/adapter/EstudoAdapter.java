...
public class EstudoAdapter extends BaseAdapter {
	...
	public long getItemId(int position) {
         return estudos.get(position).hashCode();
	}

	@Override
	public View getView(final int position, View convertView, ViewGroup parent) {
		if (convertView == null) {
			convertView = inflater.inflate(R.layout.gdv_assuntos_estudados, parent, false);
		}
		RecordHolder holder = new RecordHolder();

		holder.txvNumSeq = convertView.findViewById(R.id.gdv_assuntos_estudados_txv_num_seq);
        holder.txvNomeAssunto = convertView.findViewById(R.id.gdv_assuntos_estudados_txv_nome_assunto);
        holder.txvTempoEstudo = convertView.findViewById(R.id.gdv_assuntos_estudados_txv_tempo_estudo);
        holder.btnRemover = convertView.findViewById(R.id.gdv_assuntos_estudados_btn_remover);
