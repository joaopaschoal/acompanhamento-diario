...
import joaopaulo.acompanhamentodiario.view.activity.NewProjetoActivity;
...
public class ProjetoTecnologiaAdapter extends GridViewAdapter<ProjetoTecnologia> {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		holder.txvNumSeq = convertView.findViewById(R.id.gdv_tecnologias_projeto_txv_num_seq);
        holder.imgIsTecnologiaPrincipal = convertView.findViewById(R.id.gdv_tecnologias_projeto_img_is_tecnologia_principal);
        holder.txvNomeTecnologia = convertView.findViewById(R.id.gdv_tecnologias_projeto_txv_nome_tecnologia);
        holder.btnRemover = convertView.findViewById(R.id.gdv_tecnologias_projeto_btn_remover);
