...
import joaopaulo.acompanhamentodiario.view.adapter.TrabalhoAdapter;
...
public class AcompanhamentoTrabalhosActivity extends BaseActivity {
    ...
    private void bindEvents() {
        //Btn Avançar Click
        Button btnAvancarParaExercicios = findViewById(R.id.acompanhamento_trabalhos_btn_avancar);
