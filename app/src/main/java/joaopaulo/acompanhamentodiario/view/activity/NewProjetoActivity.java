...
import joaopaulo.acompanhamentodiario.business.bo.NaturezaProjetoBO;
import joaopaulo.acompanhamentodiario.business.bo.NaturezaProjetoBOImpl;
...
import joaopaulo.acompanhamentodiario.business.bo.ProjetoTecnologiaBO;
import joaopaulo.acompanhamentodiario.business.bo.ProjetoTecnologiaBOImpl;
import joaopaulo.acompanhamentodiario.business.bo.TecnologiaBO;
import joaopaulo.acompanhamentodiario.business.bo.TecnologiaBOImpl;
...
import joaopaulo.acompanhamentodiario.view.adapter.ProjetoTecnologiaAdapter;
...
public class NewProjetoActivity extends BaseActivity {
	...
	public void clearScreen() {
		...
		EditText edtName = findViewById(R.id.new_projeto_edt_name_projeto);
		edtName.getText().clear();
        CheckBox chkTecnologiaPrincipal = findViewById(R.id.new_projeto_chk_principal_tecnologia);
    ...
    protected void bindEvents() {
        ...
        ImageButton btnIncluirTecnologia = findViewById(R.id.new_projeto_btn_inlcuir_tecnologia);
        btnIncluirTecnologia.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Spinner spnTecnologias = findViewById(R.id.new_projeto_spn_tecnologias);
                CheckBox chkFlgTecnologiaPrincipal = findViewById(R.id.new_projeto_chk_principal_tecnologia);
        ...
        Button btnSalvar = findViewById(R.id.new_projeto_btn_save_projeto);
        ...
        Button btnVoltar = findViewById(R.id.new_projeto_btn_voltar);
    ...
    protected Projeto fillObjectFromScreen(Projeto projeto) {
		...
		EditText edtNome = findViewById(R.id.new_projeto_edt_name_projeto);
        Spinner spnNaturezasProjeto = findViewById(R.id.new_projeto_spn_naturezas_projeto);
        Spinner spnDonosProduto = findViewById(R.id.new_projeto_spn_dono_do_produto);
	...
	protected void loadNaturezasProjetoSpinner() {
		...
		List<NaturezaProjeto> naturezasProjeto;
		try {
